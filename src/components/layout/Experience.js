  ...
  return (
    <div>
      ...
      <p className='make-your-visit-p' style={{ marginLeft: '5px', marginRight: '5px' }}>
        We ensure that once we take a project on-board, we provide 360 degree solutions. As Arpatech
        is a technological hub, we give your project the ultimate platform it needs to be scalable
        and successful.
      </p>
