      ...
      <div className='container-fluid'>
        <div className='sub-main-content'>
          <div className='tab-content'>
                          ...
                          <div className='col-lg-3 p-0 m-0'>
                            <div className='item filterimg1 scale-in-br'>
                              <div className='caption'>
                                <p className='Noor-title'>"Noor Island is a gem of Sharjah"</p>
                  ...
                  <div className='col-lg-6'>
                    <ul className='nav nav-tabs digitalop-tabs-a back-ul-color'>
                      <li style={{ marginLeft: '200px' }}>
                        ...
                        <a href='#sub1' className='nav-link active'>
                          Test Tabs
                        </a>
                      </li>
                      <li>
                        <i className='fas fa-users' />
                        <a href='#sub2' className='nav-link'>
                          Test Tabs
                        </a>
                      </li>
                      <li>
                        <i className='fas fa-users' />
                        <a href='#sub3' className='nav-link'>
                          Test Tabs
                        </a>
                      </li>
                      <li>
                        <i className='fas fa-users' />
                        <a href='#sub4' className='nav-link'>
                          Test Tabs
                        </a>
                      </li>
                      <li>
                        <i className='fas fa-users' />
                        <a href='#sub5' className='nav-link'>
                          Test Tabs
                        </a>
                      </li>
                      <li>
                        <i className='fas fa-users' />
                        <a href='#sub6' className='nav-link'>
                          Test Tabs
                        </a>
                      </li>
                      <li>
                        <i className='fas fa-users' />
                        <a href='#sub7' className='nav-link'>
                          Test Tabs
                        </a>
                      </li>
                    </ul>
            ...
            {/*Set 1  */}
            {/* Set 2 */}
            <div className='tab-pane' id='set2'>
              <div className='tabbable'>
                <div className='row'>
                  <div className='col-lg-6 visit-unoque-one'>
                    <div className='tab-content'>
              ...
              <div className='row'>
                ...
                <div className='col-lg-6'>
                  ...
                  <p className='make-your-visit-p'>
                    We ensure that once we take a project on-board, we provide 360 degree solutions.
                    As Arpatech is a technological hub, we give your project the ultimate platform
